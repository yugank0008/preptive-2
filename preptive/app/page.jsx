        ...
        <section className="py-12 bg-gradient-to-br from-gray-50 to-white rounded-3xl p-8 md:p-12" aria-labelledby="why-choose-heading">
          <div className="max-w-4xl mx-auto">
            <h2 id="why-choose-heading" className="mb-8 text-2xl font-bold text-center text-gray-900">
              Why Choose Preptive for Exam Preparation?
            </h2>
            ...
            <div className="mt-12 p-6 bg-white rounded-2xl shadow-lg border border-gray-100">
              <h3 className="text-xl font-bold text-gray-900 mb-4">
                Preptive - Your Trusted Exam Preparation Partner
              </h3>
              <p className="text-gray-700 mb-4">
                Preptive is India's leading platform for competitive exam preparation, providing 
                timely updates, verified information, and comprehensive resources for exams like 
              ...
              <p className="text-gray-700">
                We help millions of aspirants stay updated with the latest exam notifications, 
                syllabus changes, admit card releases, result announcements, and job vacancies 
                across various government sectors. Our platform is optimized for mobile devices 
                and provides the most accurate and timely information to help you succeed in 
