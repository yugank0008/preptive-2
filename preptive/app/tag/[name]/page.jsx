  ...
  try {
    ...
    return (
      <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex items-center justify-between">
              ...
              <nav aria-label="Breadcrumb">
                <ol className="flex items-center space-x-2">
                  ...
                  <li>
                    <Link href="/tags" className="text-sm font-medium text-blue-100 hover:text-white">
                      Tags
                    </Link>
                  </li>
                  <li className="text-blue-200">/</li>
        ...
        <main className="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          <div className="mt-16 p-1">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p>
                Explore all articles and exam preparation resources tagged with 
                <strong> {tag.name}</strong> on Preptive. We provide comprehensive 
                study materials, latest updates, syllabus, admit cards, results, 
                and exam notifications to help you stay ahead in your competitive 
        ...
        {/* Related Categories (Same as category page) */}
        <section className="bg-emerald-50 py-16 mt-4 border-t">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4">
              {['Jobs', 'Results', 'Admit Card', 'Syllabus', 'News'].map((cat) => (
                <Link
                  key={cat}
