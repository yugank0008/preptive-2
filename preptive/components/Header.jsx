...
const Header = () => {
  ...
  const allNavItems = [
    ...
    { name: 'Jobs', icon: <BiBriefcase className="w-6 h-6 md:w-5 md:h-5" />, href: '/jobs' },
    { name: 'Results', icon: <TiDocumentText className="w-6 h-6 md:w-5 md:h-5" />, href: '/results' },
    { name: 'Admit Card', icon: <TiDownload className="w-6 h-6 md:w-5 md:h-5" />, href: '/admit-card' },
    { name: 'Syllabus', icon: <BiBookContent className="w-6 h-6 md:w-5 md:h-5" />, href: '/syllabus' },
  ];
